...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
      ...
      <main>
        <h1 class="mb-0">Hai, Saya Regita Pramudya Utami</h1>
        <div class="mb-5">
        <p class="lead mb-3">Web Designer &amp; Developer</p>
        <p>Saya lulusan dari D4 Manajemen Informatika Di Politeknik Negeri Sriwijaya, memiliki kemampuan dibidang Web Designer dan Developer.</p>
        <p>Dan saya telah mendesain dan mengembangkan dua produk dan satu aplikasi mobile untuk meningkatkan efosiensi kerja. </p>
        </div>
